defmodule AboutComp do
  use Phoenix.Component

  def historie(assigns) do
    ~H"""
    ...
    ~H"""
      <div id="section3" class="hidden odsazeni">
        <div class="grid grid-cols-4 grid-rows-8 gap-4 mt-4">
          ...
          >
            <!-- Profile picture /////////////////////////////////////////////////////////////////////////////-->
            <div class="about-profile" style="background-image: url(/images/about/marcel.png)">
            </div>
            <!-- Name -->
          ...
          >
            <!-- Profile picture -->
            <div class="about-profile" style="background-image: url(/images/about/omar.png)">
            </div>
            <!-- Name -->
          ...
          >
            <!-- Profile picture -->
            <div class="about-profile" style="background-image: url(/images/about/zs/Petr-Cerny-500x438.jpg)">
            </div>
            <!-- Name -->
          ...
          >
            <!-- Profile picture -->
            <div class="about-profile" style="background-image: url(/images/about/zs/Petra-Huskova-500x438.jpg)">
            </div>
            <!-- Name -->
          ...
          >
            <!-- Profile picture -->
            <div class="about-profile" style="background-image: url(/images/about/zs/Milan-Broz-500x438.jpg)">
            </div>
            <!-- Name -->
          ...
          >
            <!-- Profile picture -->
            <div class="about-profile" style="background-image: url(/images/about/zs/Zuzana-Lorencova-500x438.jpg)">
            </div>
            <!-- Name -->
            <p class="font-bold">
              Zuzana Lorenco</p>
          ...
          >
            <!-- Profile picture -->
            <div class="about-profile" style="background-image: url(/images/about/zs/Adrian-Sirek-500x438.jpg)">
            </div>
            <!-- Name -->
