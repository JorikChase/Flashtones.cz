defmodule KurzNav do
    ...
    ~H"""
      ...
      <div class="kurz-nav">
        <a href="/plavani/summer-camp" class="kurz-item">
          ...
          <span class="inline-button align-right plavani-link">Více informací<img alt="Logo kurzu" src="/images/icon/arrow-right-plavani.svg"></span>
        </a>
    ...
    ~H"""
      ...
      <div class="kurz-nav">
        <a href="/lyzovani/weekend" class="kurz-item">
          ...
          <p>Je jedinečný koncept spojující základní plaveckou výuku, školku v přírodě, sportovní a zábavní program pro děti předškolního věku. Kurz je určen pro děti ve věku 4-6 let.</p>
          <span class="inline-button align-right lyzovani-link">Více informací<img alt="Logo kurzu" src="/images/icon/arrow-right-lyzovani.svg"></span>
        </a>
      </div>
    """
  end
    ...
    ~H"""
      ...
      <div class="kurz-nav">
        <a href="/enviro/summer" class="kurz-item">
          ...
          <span class="inline-button align-right enviro-link">Více informací<img alt="Logo kurzu" src="/images/icon/arrow-right-enviro.svg"></span>
        </a>
  ...
  def vyletyPoznavaci(assigns) do
    ~H"""
      ...
      <div class="kurz-nav">
        <a href="/vylety/berlin" class="vylet-item" style="background-image: url(/images/vylety/berlin/berlin-head.jpg)">
          <h4>Berlín 20. století</h4>
        </a>
        <a href="/vylety/terezin" class="vylet-item" style="background-image: url(/images/vylety/terezin/terezin-head.jpg)">
          <h4>Pevnostní město Terezín</h4>
        </a>
        <a href="/vylety/osvetim" class="vylet-item" style="background-image: url(/images/vylety/osvetim/osvetim-head.jpg)">
          <h4>Osvětim</h4>
        </a>
        <a href="/vylety/tabor" class="vylet-item" style="background-image: url(/images/vylety/tabor/tabor-head.webp)">
          <h4>Tábor</h4>
        </a>
        <a href="/vylety/drazdany" class="vylet-item" style="background-image: url(/images/vylety/drazdany/drazdany-head.jpg)">
          <h4>Drážďany</h4>
        </a>
        <a href="/vylety/kutna-hora" class="vylet-item" style="background-image: url(/images/vylety/kutna-hora/kutna-hora-head.jpg)">
          <h4>Kutná Hora</h4>
        </a>
        <a href="/vylety/mnichov" class="vylet-item" style="background-image: url(/images/vylety/mnichov/mnichov-head.jpg)">
          <h4>Mnichov</h4>
        </a>
        <a href="/vylety/boleslav" class="vylet-item" style="background-image: url(/images/vylety/mlada-boleslav/mlada-boleslav-head.JPG)">
          <h4>Mladá Boleslav - Muzeum Škoda</h4>
        </a>
        <a href="/vylety/praha" class="vylet-item" style="background-image: url(/images/vylety/praha/praha-head.jpg)">
          <h4>Praha</h4>
        </a>
      </div>
    """
  ...
  def vyletyEnviromentalni(assigns) do
    ~H"""
      ...
      <div class="kurz-nav">
        <a href="/vylety/priroda/aves-brandysek" class="vylet-item" style="background-image: url(/images/vylety/brandysek.jpeg)">
          <h4>Záchranná stanice Aves Brandýsek</h4>
        </a>
        <a href="/vylety/priroda/centrum-jaromer" class="vylet-item" style="background-image: url(/images/vylety/jaromer.jpg)">
          <h4>Záchranné centrum Jaroměř</h4>
        </a>
        <a href="/vylety/priroda/ekocentrum-huslik" class="vylet-item" style="background-image: url(/images/vylety/huslik.jpg)">
          <h4>Ekocentrum Huslík</h4>
        </a>
        <a href="/vylety/priroda/ekocentrum-hulice" class="vylet-item" style="background-image: url(/images/vylety/hulice.jpeg)">
          <h4>Ekocentrum Hulice</h4>
        </a>
        <a href="/vylety/priroda/stanice-hrachov" class="vylet-item" style="background-image: url(/images/vylety/hrachov.jpg)">
          <h4>Záchranná stanice Hrachov</h4>
        </a>
        <a href="/vylety/priroda/motylarium-votice" class="vylet-item" style="background-image: url(/images/vylety/votice.jpg)">
          <h4>Motýlárium Votice</h4>
        </a>
        <a href="/vylety/priroda/ekocentrum-vlasim" class="vylet-item" style="background-image: url(/images/vylety/vlasim.jpeg)">
          <h4>Podblanické ekocentrum Vlašim</h4>
        </a>
        <a href="/vylety/priroda/kurz-remesel" class="vylet-item" style="background-image: url(/images/vylety/remesla.jpeg)">
    ...
    ~H"""
      ...
      <div class="kurz-nav odsazeni">
        <a href="/zs/blog/sablony" class="kurz-item">
          ...
          <span class="inline-button align-right deti-link">Více informací<img alt="Logo kurzu" src="/images/icon/arrow-right-deti.svg"></span>
        </a>
