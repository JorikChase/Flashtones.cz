  ...
  def detiHero(assigns) do
    ~H"""
      <div class="hero">
        ...
        <div class="relative">
          <div class="carousel">
            <img src="/images/zs/Hero1.jpeg" alt="Image 1" class="carousel-item">
            <img src="/images/zs/Hero3.jpeg" alt="Image 2" class="carousel-item">
            <img src="/images/zs/Hero1.jpeg" alt="Image 3" class="carousel-item">
          ...
          <div class="carousel-nav flex justify-center mt-4">
            <button class="carousel-control noBreak" onclick="goToSlide(0)">
              <img src="/images/zs/Hero1.jpeg" alt="Image 1">
              <a>
                veta nahore
              </a>
            </button>
            ...
            <button class="carousel-control noBreak" onclick="goToSlide(2)">
              <img src="/images/zs/Hero1.jpeg" alt="Image 3">
              <a>
                veta nahore
              </a>
            </button>
