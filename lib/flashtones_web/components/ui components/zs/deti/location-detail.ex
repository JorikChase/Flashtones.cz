  ...
  def astra(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        vozíčkáře i dva pokoje bez bariér. <br />
        <br /> Hotel nabízí bazén o rozměrech 8x12m, který je ideální pro
      ...
      <p>
        ...
        cestu vlakem a kurz pro rodiče tak radikálně zlevnit. <br />
        <br /> Výuka plavání v rámci kurzu ZŠ Plavání probíhá ve 12 m dlouhém
  ...
  def brandys(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        dvou až čtyřlůžkových pokojích. <br />
        <br /> Hotel byl postaven a zkolaudován v roce 1992. Od roku 2018
        ...
        hotel. <br />
        <br /> Historie hotelu je velmi rozmanitá a bohatá na zajímavé sportovní
      ...
      <p>
        ...
        výuku dětí mladšího i staršího školního věku. <br />
        <br /> Doplňkový sportovní program probíhá na sousedních hřištích,
  ...
  def bystre(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        své oblíbené místo. <br />
        <br /> Hotelový komplex vznikl propojením několika budov, nejstarší
        ...
        19 pokojů, 52 lůžek + přistýlky. <br />
        <br /> Původní a zároveň současný majitel je místní rodák Zdeněk Horák.
      ...
      <p>
        ...
        dětí, tedy 20 až 24 žáků. <br />
        <br /> Pro večerní programy a mokrou variantu doplňkového sportovního
  ...
  def energetik(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        v zimních měsících nabízí impozantní pohled na osvětlenou pláň. <br />
        <br /> Výstavba hotelu proběhla v letech 1974-1979. Rekonstrukce
        ...
        bazén 16x8 m, sauna, fitness, výtah, WIFI. <br />
        <br /> Hotel leží ve výšce cca 1000 m n. m. a v okolí jsou tak dostupné
  ...
  def lugsteinhof(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        lze plně využívat zdarma veškerou vybavenost, kuželky, využít
  ...
  def rousarka(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        plaveckých lekcí. <br />
        <br /> Pro doplňkové aktivity jsou k dispozici široké možnosti
  ...
  def tetreviBoudy(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        Žalý a do kraje. <br />
        <br /> Hotel nabízí luxusní nerezový bazén o velikosti 6x12,5 m,
        ...
        koupelnu se sprchou a fénem. <br />
        <br /> V restauraci se podávají tradiční pokrmy české kuchyně z
        nejkvalitnějších lokálních surovin.
        Pro děti je připraven dětský klub a dětské hřiště, pískoviště
        a skluzavky. <br />
        <br /> Hotel nabízí jak venkovní, tak vnitřní aktivity, mezi které
      ...
      <p>
        ...
        Pobyt na Tetřevích boudách totiž stojí za to. <br />
        <br /> Výuka plavání v rámci kurzu ZŠ Plavání probíhá ve 12 m dlouhém
  ...
  def uKurtu(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        lyžováním. <br />
        <br /> Penzion disponuje restaurací, barem, venkovní terasou (v letních měsících s krbem),
        je vybaven sušáky na boty, lyžárnou s přímým vjezdem na sjezdovku. <br />
        <br /> Je k dispozici sauna a whirpool. <br />
  ...
  def vlasim(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        bloků navštívíme. <br />
        <br /> Kurzy plavání jsou na tomto hotelu určeny pro děti od předškolního
  ...
  def vysocina(assigns) do
    ...
    <div class="location-course-wrap top">
      ...
      <p>
        ...
        – 2001 a hostům se otevřel v roce 2002. <br />
        <br /> V roce 2020 a 2021 prošel penzion rozsáhlou rekonstrukcí. Nyní
        ...
        pohádkové sochy či posezení u krbu. <br />
        <br /> Součástí penzionu jsou hřiště na fotbal či nohejbal, volejbal,
