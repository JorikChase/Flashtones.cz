  ...
  def studio(assigns) do
    ...
    <h3 id="deti">Jaké jsou programy pro děti?</h3>
      ...
      <div class="w-full md:w-full studio-container">
        <div class="question-box-wrap"><h3 class="font-semibold">Až vyrostu</h3>
