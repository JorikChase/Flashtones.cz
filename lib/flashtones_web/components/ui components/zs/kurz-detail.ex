defmodule KurzDetail do
  ...
  def plavaniWeekend(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        Nachystali jsme pro Vás novinku- individuální výuku plavání pro Vaše děti. Pokud chcete, aby se vaše děcko co nejvíce zdokonalilo v plavání, pokud chcete
        ...
        mailu: <a href="malto:petra@zsplavani.cz" class="button-inline"> petra@zsplavani.cz </a>
        nebo volejte <a href="tel:724 168 962" class="button-inline"> 724 168 962</a>.
      </p>
    </div>
    <br />
    """
  ...
  def plavaniSaturday(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        <bold>Výuka plavání</bold>
        probíhá ve vyhřívaném bazénu za dozoru zkušených instruktorů. Děti jsou rozřazeny do skupin dle schopností. Jeden instruktor vede vždy jen jednu skupinu (cca. 10 dětí). Každá lekce trvá 50 minut a je strukturována do tří částí:
      </p>
      <ul>
        <li>
          <bold>úvodní seznámení s náplní lekce a následná rozcvička</bold>
  ...
  def plavaniSchool(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        <bold>Je unikátní formou školy v přírodě s plaváním</bold>, kde žáci absolvují během pěti až šesti dnů celkem dvacet plaveckých lekcí v deseti blocích a splní tak celou
        <bold>polovinu povinné plavecké výuky</bold>, která ji díky Opatření v souladu s 4 odst. zákona č. 561/2004 Sb. Školského zákona řadí mezi povinné výukové postupy. Dále se žáci účastní celkem pěti devadesátiminutových doplňkových sportovních programů a pěti stejně dlouhých zábavních večerních programů.
      </p>
      <h3>Jak to probíhá</h3>
      <p>
        S využítím
  ...
  def enviroSvp(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <ul>
        <li>
          <b>teoretická</b>
          – děti jsou hravou formou seznámeny s příslušnou problematikou a jejími souvislostmi. Každý blok je vždy zaměřen na jednu oblast environmentální výchovy. Součástí jsou názorné ukázky a nácviky.
        </li>
        <li>
          <b>přípravná</b>
          – v této části jsou vytvářeny či upravovány rekvizity a příslušenství pro splnění daného úkolu.
        </li>
        <li><b>aplikační</b> – instalace a samotné finální řešení úkolu.</li>
      </ul>
    </div>
    <br />
    """
  ...
  def enviroTym(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <b>
        Program V Týmu je jedinečný koncept školy v přírodě, který si klade za cíl stmelení školního kolektivu.
      </b>
      <p>
      ...
      <article>
        ...
        <p>Sociomapping je nástroj, který vizualizuje vztahy a
          ...
          s jinými testovanými vzorky.</p>
        <p>Celý proces začíná
        ...
        <p>Na základě těchto výsledků se vybírají
          ...
          hry podporující spolupráci a komunikaci.</p>
        <p>Na konci
  ...
  def praha(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        Brňané měli by poznat krásy tohoto města skalnatých říčních prahů na Vltavě. <br />
        <br /> Podíváme se na místo, odkud přemyslovští vládci začali spravovat okolní území, kde si
        ...
        hlavním městem nově vzniklého československého státu. <br />
        <br /> V novodobých dějinách byla Praha i nadále modernizována a rozšiřována a probíhala zde
        poměrně masivní výstavba. <br />
        <br /> Gotické dominanty a barokní Prahu spolu s historizujícím stylem Národního divadla a
        ...
        vzniknout stavbám jako Tančící dům či kláštěr v Emauzích. <br />
        <br /> Díky čtyřicet let trvajícímu komunistickému režimu Praha sice zažila úpadek, nicméně
        dnes je opět jednou ze světových metropolí, které stojí zato vidět. <br />
        <br /> Naši prohlídku začneme na václavském Václaváku, tedy u koně. Půjdeme dolů přes
        ...
        poutavé příběhy a legendy staré Prahy i perličky moderního z pražského života. <br />
        <br />
      </p>
    </div>
    <br />
  ...
  def osvetim(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        dni. <br />
        <br /> První část prohlídky probíhá s průvodcem po Auschwitz I, kde se nachází bývalé
        ...
        sebou do Osvětimi, než byli zabití v plynových komorách nebo zemřeli na vyčerpání, hlad <br />
        <br /> či nemoci.
        ...
        nachází taktéž výstava a bývalé odvšivovací zařízení. Na místě navštívíme také ženský <br />
        <br /> tábor, "Blok smrti" a rampu s vlakem, odkud směřovaly vlaky do tábora. <br />
        <br /> Ubytování je zajištěno v nedalekém Quest House Osvětim
        Na zpáteční cestě je dle předchozí dohody možná zastávka ve
        Věličce, největších solných dolech v Evropě (cena za žáka je cca 500 Kč), případně je <br />
        <br /> možná komentovaná prohlídka města Krakova.
      </p>
    </div>
    <br />
    """
  ...
  def terezin(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        armáda. <br />
        <br /> Prohlídka bude zahájena v Terezíně průchodem části podzemních chodeb z doby 18.
        ...
        nemocnice a později byla využita k propagandistickým účelům. <br />
        <br /> Poutavá prohlídka je proložena rozborem básní, které v ghettu napsaly samy děti, je k
        dispozici několik krátkých filmů, prezentace posledních nálezů z půd, seznámení s
        historií Židů na českém území. <br />
        <br /> Na zpáteční cestě lze návštěvu Terezína skombinovat s návštěvou královského města
  ...
  def tabor(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        studenty. <br />
        <br /> Město Tábor patří mezi nejkrásnější česká města, a přesto nepatří mezi místa
        poškozená masovou turistikou. Vyznačuje se geograficky výhodnou polohou na okraji
        jižních a středních Čech. <br />
        <br /> Prohlídka začne na tzv. parkánech, výstupem na věž Kotnov s výhledem na starobylou
        ...
        instalována expozice věnovaná dějinám Tábora, a to od pravěku až po třicetiletou válku. <br />
        <br /> Poté budeme pokračovat prohlídkou historického jádra města, s dokonale zachovalou
        sítí křivolakých uliček v gotickém duchu, které je památkovou rezervací a skýtá mnohé
        zajímavé příběhy, dokud nedorazíme na samotné Žižkovo náměstí. <br />
        <br /> Zde navštívíme Husitské muzeum, které se nalézá v budově Staré radnice na Žižkově
        ...
        podzemního labyrintu. <br />
        <br /> Na Žižkově náměstí navštívíme Muzeum čokolády a marcipánu, které nám ukáže historii
        ...
        čokolády. <br />
        <br /> Na zpáteční cestě lze provést zastávku na zřícenině gotického hradu, tzv. Kozím hrádku,
  ...
  def drazdany(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        klíčovou roli v oblasti inovací a moderních technologií v rámci celé Evropy. <br />
        <br /> Dle Spolkového úřadu pro ochranu přírody celé území Drážďan patří k velkoplošné
        ...
        prostředí. <br />
        <br /> Ihned po příjezdu vejdeme do samotného historického centra, projdeme přes Brühlovu
        terasu až ke zbytku středověkého opevnění. <br />
        <br /> Navštívíme symboly Drážďan - kostel Frauenkirche, Rezidenční zámek a Divadelní
        ...
        z nových perspektiv. <br />
        <br /> Poté budeme pokračovat k jedné z nejvýznamnějších barokních staveb v Německu
        a dominantě Drážďan Zwinger s jeho zbrojnicí a galerií starých mistrů včele s Rafaelovou
        Sixtinskou Madonou. <br />
        <br /> Tip: Doporučujeme s námi navštívit Drážďany v předvánočním čase. Drážďanský
  ...
  def berlin(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        to jak za Výmarské republiky (1918–1933), tak za Třetí říše (1933–1945). <br />
        <br /> Po osvobození města a vítězství spojenců, bylo město rozděleno do čtyř
        ...
        Západní Berlín byl politicky spojen se Spolkovou republikou Německo. <br />
        <br /> V roce 1961 začala Německá demokratická republika stavět Berlínskou zeď kolem
        ...
        politiky, médií a vědy, ale také světový dopravní uzel železniční a letecké dopravy. <br />
        <br /> Při naší návštěvě Berlína neopomeneme známou lokalitu Ostrov muzeí, kde se krom pěti
        ...
        stavby vystavěné po roce 1990. <br />
        <br /> Při naší návštěvě Berlína neskončíme ale pouze u těžkých témat. Asi jednu třetinu
        rozlohy města totiž tvoří lesy, parky, zahrady, řeky, kanály a jezera, takže se dosyta
        inspirujeme i v přírodovědné oblasti v rámci berlínské městské zeleně. <br />
        <br />
      </p>
    </div>
    <br />
  ...
  def mnichov(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        druhého stupně a středoškolské studenty. <br />
        <br /> První zmínka o Mnichovu pochází z roku 1158. To když bavorský a saský vévoda Jindřich
        ...
        městská práva. <br />
        <br /> V roce 1255 došlo k rozdělení rodu Wittelsbachů na větev falckou a bavorskou. Bavorská
        ...
        <br />
        <br />
        <br /> V období pozdní gotiky a renesance zažilo město velký kulturní rozkvět. Za vlády Viléma
        IV. a Albrechta V. se z něho stalo centrum renesance, manýrismu, ale
        také protireformace. <br />
        <br /> Podobně jak Praha, přežil Mnichov vpád švédského vojska, a přes ztrátu až třetiny
        ...
        italskému baroku, to když manželé pozvali italské architekty a stavitele. <br />
        <br /> Koncem 18. století nastal opět velký rozkvět města, poté, co se bavorský
        vévoda Maxmilián IV. Josef zásluhou napoleonské Francie stal bavorským
        králem Maximiliánem I. <br />
        <br /> Za vlády krále Ludvíka I. (1825–1848) se Mnichov stal významným evropským centrem
        ...
        rozmach s čtvrtí Schwabing, kde v této době žila řada významných spisovatelů a malířů. <br />
        <br /> Po První světové válce se Mnichov stal baštou pravice, extrémních nacionalistických
        ...
        vyrabováno přes 7000 židovských obchodů. <br />
        <br /> Na okraji náměstí Königsplatz došlo v roce 1938 k podpisu tzv. mnichovské dohody,
        ...
        politiky ústupků, appeasementu neboli politiky ustupování agresivní straně. <br />
        <br /> Dalším významným milníkem města se stalo pořádání Dvacátých Olympijských her
        ...
        světě. <br />
        <br /> Při naší návštěvě Mnichova si prohlédneme hlavní stadiony a haly XVII. letních
        olympijských her s unikátní prosklenou střechou a 291 metrů vysokou olympijskou věží s
        vyhlídkovým ochozem. <br />
        <br /> V historickém centru Mnichova budeme obdivovat dominantu města Frauenkirche s
        ...
        trhu Viktualinmarkt s bavorskými specialitami některou z tradičních dobrot. <br />
        <br /> V případě dvoudenního výletu je možné ubytování přímo ve městě a druhý den prohlídka
        ...
        Neuschwanstein postaveným Ludvíkem II. Bavorským. <br />
        <br />
      </p>
    </div>
    <br />
  ...
  def kutnaHora(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        grošů. <br />
        <br /> Bohatství kutnohorských dolů se brzy stalo základem královské moci v Čechách a
        hlavním zdrojem prostředků na velkolepé stavby Lucemburků po celé 14. století. <br />
        <br /> Druhý panovník rodu Lucemburků vládnoucí v českých zemích, Karel IV., se jako první
        ...
        architektonického i kulturního rozkvětu Českého království vůbec. <br />
        <br /> Naši prohlídku zahájíme v unikátní kostnici v Sedlci, která je vyzdobena téměř výhradně
        z lidských kostí s ostatky až 40 000 zemřelých, jakožto pozůstatků morových epidemií a
        obětí husitských válek. <br />
        <br /> Pokračovat budeme návštěvou nově zrekonstruované katedrály Nanebevzetí Panny
        ...
        kůži vyzkoušet vlastnoruční ražbu Pražského groše. <br />
        <br /> Návštěvu města Kutná Hora zakončíme prohlídkou středověkých stříbrných dolů. Zde se
        ...
        zpracování stříbrné rudy a ražbu mince. <br />
        <br />
      </p>
    </div>
    <br />
  ...
  def mladaBoleslav(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        všech historických etap moderní doby. <br />
        <br /> Expozice je umístěna ve velmi autentickém prostředí bývalých výrobních hal. Muzeum
  ...
  def vyletyPriroda(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>Každý živočišný druh hraje důležitou roli v našem ekosystému, pomáhá udržovat
        ...
        s delegátem bude již samotná cesta pro děti naučná a zajímavá. <br />
        <br /> Na místě žáci setkají s handicapovanými zvířaty, exoty i původními českými plemeny
        ...
        Cílem je živočichy vyléčit a vrátit do přírody, což je samozřejmě ne vždy možné. <br />
        <br /> Na zpáteční cestě nás čeká zábavný kvíz, žáci následně hodnotí své zážitky z výletu a
        diskutují témata s naším odborným delegátem, případně učiteli.</p>
    </div>
    <br />
    """
  end
  ...
  def staniceHrachov(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>Vezmeme vás na na výlet do jedné z nejmodernějších záchranných stanic s ekocentrem
        ...
        a osvětovou činností. <br />
        <br /> Cestou autobusem do Hrachova nás čeká zábavný odborný program, takže nám cesta
        uteče a připraví nás na budoucí zážitek. <br />
        <br /> Záchranná stanice Hrachov představuje nejen bezpečný přístav pro zraněná, nemocná
        či osiřelá zvířata, ale také inspirativní zážitek pro dětské návštěvníky všech věkových
        kategorií. <br />
        <br /> Na vlastní kůži zažijeme jedinečný pohled do zákulisí záchranné stanice, kde budeme
        uvidíme zvířata v různých stadiích rehabilitace a přípravy na návrat do volné přírody. <br />
        <br /> Děti uslyší mnohé inspirativní příběhy o záchraně, rehabilitaci a úspěšných návratech
        zvířat do přirozeného prostředí. Dozví se, co dělat, pokud naleznou v přírodě zraněné
        zvíře a jak mu nejlépe pomoci. <br />
        <br /> Na zpáteční cestě budeme diskutovat s naším odborným lektorem veškeré zážitky a
        poznatky. Čeká nás i zábavný kvíz.</p>
    </div>
    <br />
    """
  end
  ...
  def centrumJaromer(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        Návštěva Záchranného centra Jaroměř nám umožní vidět problematiku ochrany
        živočišných druhů v ČR z jiné perspektivy. Zážitek ze záchranné stanice Jaroměř nabízí
        příležitost, jak prohloubit povědomí o ochraně přírody a péči o volně žijící živočichy. <br />
        <br />
        ...
        <br />
        <br /> Následně se setkáme se samotnými zvířaty-různými druhy ptáků, savců a dalších zvířat,
  ...
  def ekocentrumHuslik(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        Tento výlet nabízí několik variant programu pro menší i větší děti, může však být i
        zajímavou exkurzí pro středoškolské studenty. <br />
        <br />
        ...
        ekologických projektů a udržitelného životního stylu. <br />
        <br /> Areál Ekocentra Huslík je spojen se záchrannou stanicí a rozkládá se téměř na 100 000
        ...
        uzpůsobený pro vzdělávání. <br />
        <br /> Dozvíme se, kdo bydlí v úlu a jaká je včelí životní náplň, vyzkoušíme si včelařské
        kombinézy a klobouky, složíme si model úlu a ochutnáme včelí produkty. <br />
        <br /> Uvidíme krávy, kozy, ovečky a prasátka, vyzkoušíme si krmení i dojení čerstvého mléka,
        ochutnáme místní domácí mléčné produkty, alternativně si zkusíme vlastnoručně
        vyrobit čerstvý sýr, který si dovezeme domů jako suvenýr. <br />
        <br />
        Při prohlídce areálu se dozvíme, co dělat, když najdeme zraněné zvíře a jak mu pomoci či
        jaké tajemství skrývá lužní les. <br />
        <br /> Objevíme širokou škálu ekologických a udržitelných technologií, které dětem pomohou
        ...
        prostorech, které slouží jako ukázka udržitelného zahradničení a péče o krajinu. <br />
        <br /> Na zpáteční cestě se budeme moci zastavit v Poděbradech na kolonádě napít se ze
  ...
  def ekocentrumHulice(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        věku. <br />
        <br /> Voda tvoří až dvě třetiny Země a až 60 % lidských těl. Nedostatek vody je původcem
        ...
        stále nedostatečná. <br />
        <br /> Téma vody prostupuje mnoha našimi aktivitami a je platformou pro jeden z našich
        největších kurzů, kurz ZŠ Plavání. Je pro nás vítaným oživením, moci žákům představit
        tento živel i z trochu jiného úhlu než z pohledu výuky plavání a vodní záchrany. <br />
        <br /> V hulickém Vodním domě lze najít o vodě v tematických expozicích takřka vše.
        ...
        sledovat ryby na dně expoziční nádrže. <br />
        <br /> Ve Včelím světě se děti pomocí moderních technologií seznámí se životem včel a poznají
        ...
        výroba vlastní svíčky z včelího vosku, kterou si děti odnesou na památku. <br />
        <br />
      </p>
    </div>
    <br />
  ...
  def ekocentrumVlasim(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        cestou budou žáci připraveni naším odborným delegátem na to, co je čeká. <br />
        <br /> Navštívíme nejprve místní záchrannou stanici, která pomáhá zraněným a jinak
        ...
        na rušných silničních komunikacích. <br />
        <br /> Samozřejmě si děti prohlédnou zblízka mnohé živočichy a poslechnou jejich jednotlivé
        příběhy. <br />
        <br /> V Domě přírod Blaníku uvidí expozici věnovanou přírodním, geologickým a kulturně
        ...
        hlubší informace o regionu v kontextu historie a legend. <br />
        <br /> Vodní dům následně zábavnou formou poinformuje děti o významu vody pro přírodu i
        ...
        zadrnká na hravou strunu všech dětí nejrůznějšími vodními atrakcemi. <br />
        <br /> Na zpáteční cestě budeme diskutovat s naším odborným lektorem veškeré zážitky a
        poznatky. Čeká nás i zábavný kvíz. <br />
        <br />
      </p>
    </div>
    <br />
  ...
  def kurzRemesel(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        ...
        kurzu, mohou okusit některé alternativy své budoucí profese. <br />
        <br /> První den navštívíme Centrum řemesel v Botanicus poblíž Lysé nad Labem. Jedná se o
        ...
        včelími úly. Samozřejmě strávíme čas i s místními zvířaty jako jsou kozy a ovce. <br />
        <br />
        Zajímavá bude i navštěva lékárny plné nejrůznějších bylinek, kde si děti vyrobí voňavé bylinkové
        mýdlo, ve svíčkárně si poté vyzkoušíme, jak se vyrábí svíčka. <br />
        <br />
  ...
  def motylariumVotice(assigns) do
    ...
    <div class="course-wrap top">
      ...
      <p>
        Zažijte s dětmi jedinečný výlet do Motýlária Votice, kde se křídla přírody setkávají s
        kouzlem barev a elegance! Ojedinělý projekt Ochrany fauny ČR proměnil staré skleníky
        v moderní interaktivní místo. <br />
        <br />
        ...
        překonává hranice mezi realitou a snem. <br />
        <br /> Cestou nás čekají zábavné a naučné aktivity, takže nám bude cesta hezky ubíhat. <br />
        <br /> V samotném Motýláriu zhlédneme nádherné expozice s tisíci motýlů létajících v krásné
        tropické zahradě plné exotických rostlin a květin, navštívíme motýlí laboratoř, kde
        budeme sledovat vývoj životního cyklu motýlů, od kukly až po dospělého motýla. <br />
        <br /> Budeme si moci pořídit fotografie s okouzlující momenty s motýly, kteří přistávají na
        květinách i rukách návštěvníků. Užijeme si klidnou atmosféru tropické zahrady, kde si
        odpočineme obklopeni krásou přírody a harmonií motýlích křídel. <br />
        <br /> Na závěr navštívíme dárkový obchod plný motýlích suvenýrů a originálních dárků. <br />
        <br /> Cestou zpět probereme naše zážitky s naším odborným lektorem.
      </p>
    </div>
    <br />
    """
