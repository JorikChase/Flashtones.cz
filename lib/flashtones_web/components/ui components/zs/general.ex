defmodule General do
  ...
  def bota(assigns) do
    ...
    <div class="comic-container" id="komiks">
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_1.jpg"
        alt="Comic page 1"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_2.jpg"
        alt="Comic page 2"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_3.jpg"
        alt="Comic page 3"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_4.jpg"
        alt="Comic page 4"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_5.jpg"
        alt="Comic page 5"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_6.jpg"
        alt="Comic page 6"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_7.jpg"
        alt="Comic page 7"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_8.jpg"
        alt="Comic page 8"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_9.jpg"
        alt="Comic page 9"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_10.jpg"
        alt="Comic page 10"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_11.jpg"
        alt="Comic page 11"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_12.jpg"
        alt="Comic page 12"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_13.jpg"
        alt="Comic page 13"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_14.jpg"
        alt="Comic page 14"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_15.jpg"
        alt="Comic page 15"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_16.jpg"
        alt="Comic page 16"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_17.jpg"
        alt="Comic page 17"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_18.jpg"
        alt="Comic page 18"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_19.jpg"
        alt="Comic page 19"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_20.jpg"
        alt="Comic page 20"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_21.jpg"
        alt="Comic page 21"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_22.jpg"
        alt="Comic page 22"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_23.jpg"
        alt="Comic page 23"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_24.jpg"
        alt="Comic page 24"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_25.jpg"
        alt="Comic page 25"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_26.jpg"
        alt="Comic page 26"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_27.jpg"
        alt="Comic page 27"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_28.jpg"
        alt="Comic page 28"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_29.jpg"
        alt="Comic page 29"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_30.jpg"
        alt="Comic page 30"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_31.jpg"
        alt="Comic page 31"
      />
      <img
        class="comic-image"
        src="/images/socci/kapela-z-boty/kapela_z_boty_32.jpg"
        alt="Comic page 32"
      />
    </div>
    ...
    <img
      ...
      src="/images/socci/vlozka/vlozka-intro-1.png"
      alt="Floating image"
    />
  ...
  def studio(assigns) do
    ...
    <div class="general">
      <div class="projekt">
        <h3>Co je Flashtones Studio</h3>
        <p>
          Flashtones Studio je místem smysluplného setkávání. Klademe si za cíl nabídnout kvalitní, a moderní volnočasové aktivity pro děti, mládež i dospělé.
        </p>
      </div>
      <div class="program">
        <h3>V čem jsou naše programy specifické</h3>
        <ul>
          ...
          <li>
            Konkurujeme televizi, sociálním sítím a počítačovým hrám a snažíme se ukazovat sílu fyzických zážitků a aktivně stráveného čas
          </li>
        </ul>
      </div>
    </div>
    ...
    <h2 class="pt-8">Kontaktní údaje</h2>
    <div class="">
      <div class="">
      ...
      <div class="gallery odsazeni">
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/vzory/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/flashtones-shapes.avif')"
            >
            </div>
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/flashtones-legends-2/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/flashtones-legends.avif')"
            >
            </div>
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/jednobarevne/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/flashtones-one.avif')"
            >
            </div>
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/mysterybox/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/flashtones-mystery-box.avif')"
            >
            </div>
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/damske-dashiki/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/dashiki-damske.avif')"
            >
            </div>
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/panske-dashiki/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/dashiki-panske-kalhoty.avif')"
            >
            </div>
        ...
        <div class="product">
          <a href="https://eshop.flashtones.cz/panske-dashiki/">
            <div
              class="product-image"
              style="background-image: url('/images/produkty/dashiki-panske-kosile.avif')"
            >
            </div>
  ...
  def enviro(assigns) do
    ...
    <div class="general">
      <div class="projekt">
        ...
        <br />
        <p>Projekt ZŠ Enviro je součástí intenzivního vzdělávacího konceptu ZŠ PRO DĚTI.</p>
      </div>
      <div class="prubeh">
  ...
  def plavani(assigns) do
    ...
    <div class="general">
      <div class="projekt">
        <h3>O PROJEKTU</h3>
        <p>
          Pořádáme školní a mimoškolní plavecké kurzy s doprovodným sportovním a zábavním programem určeným dětem mladšího školního věku.
          <br />
          ...
          <br /> Projekt ZŠ Plavání je součástí intenzivního vzdělávacího konceptu ZŠ PRO DĚTI.
        </p>
      </div>
      <div class="prubeh">
        <h3>JAK TO PROBÍHÁ</h3>
  ...
  def vylety(assigns) do
    ...
    <div class="general">
      <div class="projekt">
        <h3>JAKÝ JE KONCEPT ZŠ VÝLETŮ?</h3>
        <p>
          Pořádáme jednodenní a vícedenní vzdělávací výlety pro školy a veřejnost. Stěžejní téma našich zájezdů je příroda a její ochrana a regionální historie, v neposlední řadě je pro nás podstatné i tmelení kolektivu skupiny. V případě zájmu jsme schopni pro vás vytvořit výlety přesně na míru.
        </p>
      </div>
      <div class="prubeh">
        <p>
          Již v autobuse, případně v cílovém místě po příjezdu je k dispozici náš delegát, který účastníkům pomůže zorientovat se a následně jim poutavě předává veškeré informace a zajímavosti. Nepředkládáme dětem nudná data, vše probíhá interaktivní formou a každý zájezd obsahuje mnohá zpestření ústředního tématu.
        </p>
      </div>
      <div class="program">
        <p>
          Zajišťujeme dopravu škol přímo na místo, naše moderní autobusy jsou vybaveny bezpečnostními pásy a splňují předepsané emisní normy Evropské unie.
        </p>
      </div>
    </div>
    """
  ...
  def doma(assigns) do
    ...
    <div class="general">
      <div class="projekt">
        <h3>O PROJEKTU</h3>
        <p>
          Hledáte doučování pro vaše dítě na předmět, který mu dělá problémy? Vidíte , že mu je školní hodina krátká a chce se ještě více zdokonalit v tom, co ho baví? Nebo se chce vzdělávat v tom, co školní osnovy neobsahují? Je tady jedinečná webová a mobilní aplikace, která vám zásadně pomůže a umožní vám najít rychle a přehledně toho správného pedagoga!
        </p>
      </div>
      <div class="prubeh">
        <p>
          Chcete soukromou výuku online nebo být součástí online třídy? Chcete osobní návštěvu učitele  přímo u vás doma nebo preferujete setkání na jiném místě? Stačí si vybrat!
        </p>
      </div>
      <div class="program">
        <p>
          Jste kvalifikovaný učitel, co miluje svou práci? Chcete nám pomoci budovat díky kvalitnějšímu a snadnějšímu vzdělávání lepší svět? Přidejte se k nám a společně umožněme dětem růst!
        </p>
      </div>
    </div>
    """
  ...
  def academy(assigns) do
    ...
    <div class="general">
      <div class="projekt">
        <h3>O PROJEKTU</h3>
        <p>Školící a vzdělávací centrum ZŠ Academy organizuje kurzy, školení, semináře a
          ...
          otevřené pro širokou veřejnost.</p>
      </div>
      <div class="program">
        <p>Kurzy jsou akreditované Ministerstvem školství, mládeže a tělovýchovy ČR, přidělené
