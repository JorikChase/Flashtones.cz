defmodule DetailFaq do
    ...
    <h3>Další informace</h3>
      <div class="w-full">
        ...
        <img src="/images/icon/plus-plavani.svg" alt="Ukazat podrobnou odpoved" class="self-end">
          ...
          <p class="answer mt-2">Příměstské tábory probíhají po celé léto 2026, na konkrétní nabídku se můžete podívat <a class="plavani-link font-bold" href="https://rezervace.zsprodeti.cz/zsplavani/rezervace?kurz=1">zde</a>.</p>
        </div>
        <div class="question-box p-4 bg-white shadow mb-2">
        <div class="question-box-row-wrap">
        <div class="question-box-row">
    ...
    <h3>Další informace</h3>
      <div class="w-full">
        ...
        <img src="/images/icon/plus-enviro.svg" class="self-end">
          ...
          <p class="answer mt-2">Děti absolvují čtyři devadesátiminutové lekce orientované na hry v přírodě, tradiční i netradiční hry na rozvoj rychlosti, síly, obratnosti, vytrvalosti, postřehu a smyslového vnímání.</p>
        </div>
        <div class="question-box p-4 bg-white shadow mb-2">
        <div class="question-box-row-wrap">
        <div class="question-box-row">
    ...
    <h3>Další informace</h3>
      <div class="w-full">
        ...
        <div class="question-box-row-wrap">
          <div class="question-box-row">
            <img src="/images/icon/sportovni-enviro.svg">
            <p class="font-bold">Večerní program</p>
          </div>
          <img src="/images/icon/plus-enviro.svg" class="self-end">
        </div>
        <p class="answer mt-2">Každý večer se věnuje jedné klíčové oblasti: budování
        sebevědomí, hodnot a integrity, nebo plánování a
        dosahování cílů. Tyto aktivity podporují osobnostní
        růst a motivují studenty k pozitivním změnám.
        </p>
        </div>
        <div class="question-box p-4 bg-white shadow mb-2">
        <div class="question-box-row-wrap">
  ...
  def skolniRegularCourse(assigns) do
    ~H"""
    <style>
      .question-box {
        width: 100%;
