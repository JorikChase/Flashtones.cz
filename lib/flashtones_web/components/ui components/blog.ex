defmodule Blog do
  ...
  def tiCoUci(assigns) do
    ...
    <div class="odsazeni">
      <main>
        <article>
          <h2>Význam plavání</h2>
          <p>
            Plavání je jedním z nejstarších sportů na světě. První zmínky o této aktivitě pocházejí již ze starověkého Egypta, konkrétně z maleb na stěnách hrobek v Sakkáře datovaných kolem 2500 př. n. l., kde jsou zobrazeni lidské postavy, které plavou různými plaveckými způsoby.
          </p>

          <h3>Zdravotní přínosy plavání</h3>
          <ul>
            <li>Zapojuje více než 90 % svalových skupin v těle</li>
            <li>Zlepšuje kardiovaskulární zdraví</li>
            <li>Zvyšuje vitální kapacitu plic</li>
            <li>Posiluje všechny hlavní svalové skupiny</li>
            <li>Nízké riziko zranění díky nízkému zatížení kloubů</li>
          </ul>

          <h3>Plavání jako životní dovednost</h3>
          <p>
            Podle statistik WHO každoročně utonou statisíce lidí, a mnoha z těchto tragédií by bylo možné předejít, pokud by více lidí umělo plavat. Pouze 44 % světové populace uvádí, že tuto dovednost ovládá.
          </p>
          <br />
          <br />
          <h2>Jak vybrat kvalitního plaveckého instruktora</h2>
          <br />

          <h3>1. Respektující a partnerská komunikace s dětmi</h3>
          <ul>
            <li>Aktivní naslouchání</li>
            <li>Empatie</li>
            <li>Chvála a povzbuzení</li>
          </ul>

          <h3>2. Správná metodika a struktura lekcí</h3>
          <ul>
            <li>Posloupnost cviků</li>
            <li>Intenzita zatížení</li>
            <li>Struktura lekcí</li>
          </ul>

          <h3>3. Individuální přístup</h3>
          <ul>
            <li>Přizpůsobení cvičení</li>
            <li>Kulturní odlišnosti</li>
            <li>Jazyková bariéra</li>
            <li>Zranění a tělesné postižení</li>
            <li>Psychologické odchylky a poruchy</li>
          </ul>

          <h3>4. Sebezdokonalování</h3>
          <ul>
            <li>Zdokonalování vlastních plaveckých dovedností</li>
            <li>Pedagogické zdokonalení</li>
          </ul>
          <br />
          <br />
          <h2>Závěr</h2>
          <br />
          <p>
            Plavání je skvělým sportem, který nabízí nespočet výhod pro fyzické i psychické zdraví člověka. Pro rodiče je proto klíčové vybrat správného instruktora plavání pro své ratolesti, protože právě on může ovlivnit vztah dětí k plavání na celý život.
          </p>
          <p>
            Správný instruktor by měl disponovat odbornými vědomostmi, být trpělivý, empatický a motivující. Měl přizpůsobovat výuku individuálním schopnostem, klást důraz na bezpečnost a správné chování ve vodě i mimo ni. Výběr správného instruktora může znamenat, že se plavání stane oblíbenou celoživotní aktivitou.
          </p>
        </article>
      </main>
    </div>
  ...
  def vTymu(assigns) do
    ...
    <div class="odsazeni">
      ...
      <p>
        Zajímají vás naše další kurzy? Vyzkoušejte školu v přírodě s výukou plavání <b class="plavani-link">ZŠ Plavání</b>, lyžařský kurz
        <b class="lyzovani-link">ZŠ Lyžování</b>
        nebo školu v přírodě s environmentální tématikou <b class="enviro-link">ZŠ Enviro</b>.
      </p>
      <br />
      <p>
        Kontaktujte nás na
        <b><a class="deti-link" href="mailto:info@zsprodeti.cz">info@zsprodeti.cz</a></b>
        nebo navštivte <b><a class="deti-link" href="https://www.zsprodeti.cz/">zsprodeti.cz</a></b>
        pro více informací.
      </p>
      <br />
    </div>
  ...
  def plaveckeDovednosti(assigns) do
    ~H"""
    <div
      class="max-w-6xl mx-auto p-6 my-10 pb-10 bg-white rounded-lg shadow-lg space-y-6"
      style="padding-bottom: 90px;"
    >
      <h2 class="text-2xl font-bold left text-gray-800" style="margin-top: 15px;">
        RODIČE, JE ČAS POSÍLIT PLAVECKÉ DOVEDNOSTI VAŠICH DĚTÍ!
      </h2>
      ...
      <ul class="list-disc list-inside space-y-2 text-gray-700">
        <li>
          První skupina docházela nebo dojížděla na 45 minut dlouhé lekce jednou týdně po dobu šesti měsíců
        </li>
        <li>Další skupina plavala v 90-ti minutových lekcích jednou týdně po tři měsíce</li>
        <li>
          Poslední skupina se zúčastnila intenzivního kurzu s 90-ti minutovými bloky dvakrát denně během pětidenního období
        </li>
      </ul>
      ...
      <h4 class="text-xl font-semibold text-gray-800">
        Co to znamená pro vaše plánování letních aktivit?
      </h4>
