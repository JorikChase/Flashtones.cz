defmodule FlashtonesWeb.SwimmingHloubetin do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/plavani/kurz/morning-swimming-in-hloubetin",
  ...
  def render(assigns) do
    ...
    <div class="detail-lokace course-wrap">
      ...
      <div class="category" data-category="Plavání">
        <div class="product">
          <a href="###">
            <img src="/images/hotely/hloubetin.avif" alt="Hloubetin foto" />
