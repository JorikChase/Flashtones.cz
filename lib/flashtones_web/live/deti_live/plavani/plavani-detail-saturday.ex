defmodule FlashtonesWeb.PlavaniDetailSaturdayLive do
  ...
  def mount(_params, _session, socket) do
    socket = assign(socket, favicon: "https://zsprodeti.cz/images/favicon/plavani/icon.png", canonical: "https://zsprodeti.cz/plavani/sobotni-kurzy-plavani" , page_title: "ZŠ PLAVÁNÍ", description: "Největší plavecká škola v ČR")
