defmodule FlashtonesWeb.AcademyIndexLive do
  ...
  def mount(_params, _session, socket) do
    socket = assign(socket, favicon: "https://zsprodeti.cz/images/favicon/academy/icon.png", canonical: "https://zsprodeti.cz/academy" , page_title: "ZŠ ACADEMY", description: "Školící a vzdělávací centrum ZŠ Academy pořádá akreditované kurzy, školení a semináře pro učitele, lektory a trenéry. Naše programy poskytují dovednosti využitelné ve školách i dalších vzdělávacích organizacích. Nabízíme kvalitní tým s empatickým přístupem a bohatými zkušenostmi.")
