defmodule FlashtonesWeb.AcademyIndexLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        favicon: "https://zsprodeti.cz/images/favicon/academy/icon.png",
        canonical: "https://zsprodeti.cz/academy",
        page_title: "ZŠ ACADEMY",
        meta_description:
          "Školící a vzdělávací centrum ZŠ Academy pořádá akreditované kurzy, školení a semináře pro učitele, lektory a trenéry. Naše programy poskytují dovednosti využitelné ve školách i dalších vzdělávacích organizacích. Nabízíme kvalitní tým s empatickým přístupem a bohatými zkušenostmi."
      )
  ...
  def render(assigns) do
    ...
    <div class="odsazeni">
      ...
      <div class="kazeta">
        <div class="">
          <p>
            Chcete pracovat s námi? Máte kladný vztah ke sportu a vzdělávání? Máte
            ...
            jejich hranice a umožňujeme jim další růst. <br />
            ...
            zvířatům, k živé a neživé přírodě i k lidským výtvorům. <br />
            ...
            naší publikaci Ostrov Socci. <br />
            Veškeré pobytové akce jsou v souladu se zákonem cestovní kanceláří Flashtones,
            s.r.o. Neziskové a dobrovolnické projekty zajišťuje ZŠ PRO DĚTI, z.s.
          </p>
        </div>
