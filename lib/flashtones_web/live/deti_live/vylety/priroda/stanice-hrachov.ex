defmodule FlashtonesWeb.VyletyStaniceHrachovLive do
  ...
  def render(assigns) do
    ...
    <style>
      ...
      <MenuPc.menuVyletyPc />
      <HeroSmall.staniceHrachov />
      <DetailCta.vyletyPriroda />
      <KurzDetail.staniceHrachov />
