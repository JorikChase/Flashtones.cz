defmodule FlashtonesWeb.VyletyEkocentrumVlasimLive do
  ...
  def render(assigns) do
    ...
    <style>
      ...
      <MenuPc.menuVyletyPc />
      <HeroSmall.ekocentrumVlasim />
      <DetailCta.vyletyPriroda />
      <KurzDetail.ekocentrumVlasim />
