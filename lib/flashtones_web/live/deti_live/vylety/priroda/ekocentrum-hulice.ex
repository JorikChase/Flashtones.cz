defmodule FlashtonesWeb.VyletyEkocentrumHuliceLive do
  ...
  def render(assigns) do
    ...
    <style>
      ...
      <MenuPc.menuVyletyPc />
      <HeroSmall.ekocentrumHulice />
      <DetailCta.vyletyPriroda />
      <KurzDetail.ekocentrumHulice />
