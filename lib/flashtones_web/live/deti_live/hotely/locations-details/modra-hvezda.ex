defmodule FlashtonesWeb.LokalityModraHvezdaLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/lokality/modra-hvezda",
  ...
  def render(assigns) do
    ...
    <MenuPc.menuDetiPc />
    <HeroSmall.modraHvezda />
    <LocationDetail.modraHvezda />
    <DetailFaq.modraHvezda />
    <!--<Lokace.galerie />-->
        <!--<Lokace.kurzy />-->
    <%!-- <Mapa.modraHvezda /> --%>
    <Zustanme.plavani />
