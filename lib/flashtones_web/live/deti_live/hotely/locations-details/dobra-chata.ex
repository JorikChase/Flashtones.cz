defmodule FlashtonesWeb.LokalityDobraChataLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/lokality/dobra-chata",
  ...
  def render(assigns) do
    ...
    <MenuPc.menuDetiPc />
    <HeroSmall.dobraChata />
    <LocationDetail.dobraChata />
    <DetailFaq.dobraChata />
    <!--<Lokace.galerie />-->
        <!--<Lokace.kurzy />-->
    <%!-- <Mapa.dobraChata /> --%>
    <Zustanme.plavani />
