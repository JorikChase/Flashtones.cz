defmodule FlashtonesWeb.LokalityAstraLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/lokality/astra",
        page_title: "ZŠ PRO DĚTI",
        description:
          "Příměstský tábor, primestsky tabor, škola v přírodě, skola v prirode, skoly v prirode, škola v přírodě s plaváním, škola v přírodě Praha, Příměstský tábor Praha"
      )
