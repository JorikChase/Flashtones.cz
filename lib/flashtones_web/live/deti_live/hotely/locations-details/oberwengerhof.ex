defmodule FlashtonesWeb.LokalityOberwengerhofLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/lokality/oberwengerhof",
  ...
  def render(assigns) do
    ...
    <MenuPc.menuDetiPc />
    <HeroSmall.oberwengerhof />
    <LocationDetail.oberwengerhof />
    <DetailFaq.oberwengerhof />
    <!--<Lokace.galerie />-->
        <!--<Lokace.kurzy />-->
    <%!-- <Mapa.oberwengerhof /> --%>
    <Zustanme.plavani />
