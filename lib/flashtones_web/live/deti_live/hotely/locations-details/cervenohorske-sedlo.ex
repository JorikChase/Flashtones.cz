defmodule FlashtonesWeb.LokalityCervenohorskeSedloLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/lokality/cervenohorske-sedlo",
  ...
  def render(assigns) do
    ...
    <MenuPc.menuDetiPc />
    <HeroSmall.cervenohorskeSedlo />
    <LocationDetail.cervenohorskeSedlo />
    <DetailFaq.cervenohorskeSedlo />
    <!--<Lokace.galerie />-->
        <!--<Lokace.kurzy />-->
    <%!-- <Mapa.cervenohorskeSedlo /> --%>
    <Zustanme.plavani />
    <Footer.deti />
    """
  end
