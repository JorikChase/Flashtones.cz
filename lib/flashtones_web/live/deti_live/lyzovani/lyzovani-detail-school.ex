defmodule FlashtonesWeb.LyzovaniDetailSchoolLive do
  ...
  def mount(_params, _session, socket) do
    socket = assign(socket, favicon: "https://zsprodeti.cz/images/favicon/lyzovani/icon.png", canonical: "https://zsprodeti.cz/lyzovani/school" , page_title: "ZŠ LYŽOVÁNÍ", description: "Lyžařská škola nejen o obloucích")
