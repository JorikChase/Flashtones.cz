defmodule FlashtonesWeb.LocationsEnviroLive do
  ...
  def mount(_params, _session, socket) do
    socket = assign(socket, favicon: "https://zsprodeti.cz/images/favicon/enviro/icon.png", canonical: "https://zsprodeti.cz/enviro/lokality" , page_title: "ZŠ ENVIRO", description: "Školy v přírodě s environmentální a tmelící tématikou")
