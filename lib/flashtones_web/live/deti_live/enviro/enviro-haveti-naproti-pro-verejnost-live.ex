defmodule FlashtonesWeb.EnviroHavetiNaprotiProVerejnostLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/enviro/exkurze-haveti-naproti-pro-verejnost",
  ...
  def render(assigns) do
    ...
    <DetailCta.enviroHavetiNaproti />
    <KurzDetail.havetiNaprotiProVerejnost />
    <%!-- <DetailLokace.detailLokaceEnviroPrimestske /> --%>
    <%!-- DetailFaq.verejnostPrimestaky /--%>
    <DetailLokace.detailHavetiNaprotiProVerejnost />
    <br />
