defmodule FlashtonesWeb.EnviroHavetiNaprotiProSkolyLive do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/enviro/exkurze-haveti-naproti-pro-skoly",
  ...
  def render(assigns) do
    ...
    <KurzDetail.havetiNaprotiProSkoly />
    <%!-- <DetailLokace.detailLokaceEnviroPrimestske /> --%>
    <%!-- DetailFaq.verejnostPrimestaky /--%>
    <DetailLokace.detailHavetiNaprotiProSkoly />
    <br />
