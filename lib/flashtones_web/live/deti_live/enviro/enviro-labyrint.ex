defmodule FlashtonesWeb.EnviroLabyrint do
  ...
  def mount(_params, _session, socket) do
    socket =
      assign(socket,
        ...
        canonical: "https://zsprodeti.cz/enviro/labyrint",
  ...
  def render(assigns) do
    ...
    <MenuPc.menuEnviroPc />
    <HeroSmall.enviroLabyrint />
    <DetailCta.enviroLabyrint />
    <KurzDetail.enviroLabyrint />
    <!--<h3>Další informace</h3>-->
      <!--<DetailFaq.detailFaq />-->
    <DetailFaq.enviroLabyrint />
