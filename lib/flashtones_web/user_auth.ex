defmodule FlashtonesWebL.UserAuth do
  ...
  the current_user:
      ...
      defmodule FlashtonesWeb.PageLive do
        use FlashtonesWeb, :live_view

        on_mount {FlashtonesWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FlashtonesWeb.UserAuth, :ensure_authenticated}] do
