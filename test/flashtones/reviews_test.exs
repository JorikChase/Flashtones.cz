defmodule Flashtones.ReviewsTest do
  use Flashtones.DataCase

  alias Flashtones.Reviews

  describe "reviews" do
    alias Flashtones.Reviews.Review

    import Flashtones.ReviewsFixtures
    ...
    test "create_review/1 with valid data creates a review" do
      ...
      assert review.heading == "some heading"
    end
    ...
    test "update_review/2 with valid data updates the review" do
      ...
      assert review.heading == "some updated heading"
    end
